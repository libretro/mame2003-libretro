 ...
 * Official RetroArch documentation for the mame2003-libretro core are published at [https://docs.libretro.com/](https://docs.libretro.com/). They can be [edited and improved by users via github.com](https://github.com/libretro/docs/blob/master/docs/library/mame2003.md).
