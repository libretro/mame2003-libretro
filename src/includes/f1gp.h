extern uint16_t *f1gp_spr1vram,*f1gp_spr2vram,*f1gp_spr1cgram,*f1gp_spr2cgram;
extern uint16_t *f1gp_fgvideoram,*f1gp_rozvideoram;
extern uint16_t *f1gp2_sprcgram,*f1gp2_spritelist;
