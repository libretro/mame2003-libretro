...
/* defined in vidhrdw/ */
extern uint8_t *lasso_videoram;
extern uint8_t *lasso_colorram;
extern uint8_t *lasso_spriteram;
extern size_t lasso_spriteram_size;
extern uint8_t *lasso_bitmap_ram;
extern uint8_t *wwjgtin_track_scroll;
