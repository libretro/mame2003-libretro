...
extern uint16_t *cave_videoregs;

extern uint16_t *cave_vram_0, *cave_vctrl_0;
extern uint16_t *cave_vram_1, *cave_vctrl_1;
extern uint16_t *cave_vram_2, *cave_vctrl_2;
extern uint16_t *cave_vram_3, *cave_vctrl_3;
