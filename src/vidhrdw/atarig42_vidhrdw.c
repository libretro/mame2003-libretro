...
uint16_t atarig42_playfield_base;
uint16_t atarig42_motion_object_base;
uint16_t atarig42_motion_object_mask;
...
static uint32_t atarig42_playfield_scan(uint32_t col, uint32_t row, uint32_t num_cols, uint32_t num_rows)
{
