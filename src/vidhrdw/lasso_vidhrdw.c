...
uint8_t *lasso_videoram;
uint8_t *lasso_colorram;
uint8_t *lasso_spriteram;
size_t lasso_spriteram_size;
uint8_t *lasso_bitmap_ram; 	/* 0x2000 bytes for a 256 x 256 x 1 bitmap */
uint8_t *wwjgtin_track_scroll;
