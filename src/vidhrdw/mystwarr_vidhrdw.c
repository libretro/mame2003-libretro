...
{
	uint8_t *ROM1 = (uint8_t *)memory_region(REGION_GFX4);
	uint8_t *ROM2 = (uint8_t *)memory_region(REGION_GFX4);
...
{
	uint8_t *ROM = (uint8_t *)memory_region(REGION_GFX4);
...
{
	uint8_t *ROM = (uint8_t *)memory_region(REGION_GFX3);
