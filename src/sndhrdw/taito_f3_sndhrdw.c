...
/*gamezfan keeping the code which fixes the sound in Riding Fight seperate from the other F3 games which
dont need it, plus better to be on the safe side incase the changes causes problems in the other games*/
