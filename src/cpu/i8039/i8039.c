...
static uint8_t i8039_reg_layout[] = {
...
static uint8_t i8039_win_layout[] = {
...
typedef struct
{
	...
	uint8_t	A, SP, PSW;
	uint8_t	RAM[128];
	uint8_t	bus, f1;		/* Bus data, and flag1 */
	uint8_t	P1, P2;			/* Internal Port 1 and 2 latched outputs */

	uint8_t	pending_irq, irq_executing, masterClock, regPtr;
	uint8_t	t_flag, timer, timerON, countON, xirq_en, tirq_en;
	uint16_t	A11, A11ff;
	uint8_t	irq_state, irq_extra_cycles;
...
static INLINE void CLR (uint8_t flag) { R.PSW &= ~flag; }
static INLINE void SET (uint8_t flag) { R.PSW |= flag;  }
...
static INLINE void push(uint8_t d)
{
	intRAM[8+R.SP++] = d;
	R.SP  = R.SP & 0x0f;
	R.PSW = R.PSW & 0xf8;
...
static INLINE void M_ADD(uint8_t dat)
{
	uint16_t temp;
...
static INLINE void M_ADDC(uint8_t dat)
{
	uint16_t temp;
...
static INLINE void M_CALL(uint16_t addr)
{
	push(R.PC.b.l);
...
static INLINE void M_XCHD(uint8_t addr)
{
	uint8_t dat = R.A & 0x0f;
	R.A &= 0xf0;
...
static void call(void)		 { uint8_t i=M_RDMEM_OPCODE(); M_CALL(i | R.A11); }
static void call_1(void)	 { uint8_t i=M_RDMEM_OPCODE(); M_CALL(i | 0x100 | R.A11); }
static void call_2(void)	 { uint8_t i=M_RDMEM_OPCODE(); M_CALL(i | 0x200 | R.A11); }
static void call_3(void)	 { uint8_t i=M_RDMEM_OPCODE(); M_CALL(i | 0x300 | R.A11); }
static void call_4(void)	 { uint8_t i=M_RDMEM_OPCODE(); M_CALL(i | 0x400 | R.A11); }
static void call_5(void)	 { uint8_t i=M_RDMEM_OPCODE(); M_CALL(i | 0x500 | R.A11); }
static void call_6(void)	 { uint8_t i=M_RDMEM_OPCODE(); M_CALL(i | 0x600 | R.A11); }
static void call_7(void)	 { uint8_t i=M_RDMEM_OPCODE(); M_CALL(i | 0x700 | R.A11); }
...
#ifdef MESS
	static void djnz_r0(void)	{ uint8_t i=M_RDMEM_OPCODE(); R0--; if (R0 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void djnz_r1(void)	{ uint8_t i=M_RDMEM_OPCODE(); R1--; if (R1 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void djnz_r2(void)	{ uint8_t i=M_RDMEM_OPCODE(); R2--; if (R2 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void djnz_r3(void)	{ uint8_t i=M_RDMEM_OPCODE(); R3--; if (R3 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void djnz_r4(void)	{ uint8_t i=M_RDMEM_OPCODE(); R4--; if (R4 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void djnz_r5(void)	{ uint8_t i=M_RDMEM_OPCODE(); R5--; if (R5 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void djnz_r6(void)	{ uint8_t i=M_RDMEM_OPCODE(); R6--; if (R6 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void djnz_r7(void)	{ uint8_t i=M_RDMEM_OPCODE(); R7--; if (R7 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
#else
	static void djnz_r0(void)	{ uint8_t i=M_RDMEM_OPCODE(); R0--; if (R0 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void djnz_r1(void)	{ uint8_t i=M_RDMEM_OPCODE(); R1--; if (R1 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void djnz_r2(void)	{ uint8_t i=M_RDMEM_OPCODE(); R2--; if (R2 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void djnz_r3(void)	{ uint8_t i=M_RDMEM_OPCODE(); R3--; if (R3 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void djnz_r4(void)	{ uint8_t i=M_RDMEM_OPCODE(); R4--; if (R4 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void djnz_r5(void)	{ uint8_t i=M_RDMEM_OPCODE(); R5--; if (R5 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void djnz_r6(void)	{ uint8_t i=M_RDMEM_OPCODE(); R6--; if (R6 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void djnz_r7(void)	{ uint8_t i=M_RDMEM_OPCODE(); R7--; if (R7 != 0) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
#endif
...
/* static void jmp(void)	 { uint8_t i=M_RDOP(R.PC.w.l); R.PC.w.l = i | R.A11; }
 */

static void jmp(void)
{
	uint8_t i=M_RDOP(R.PC.w.l);
	uint16_t oldpc,newpc;
...
#ifdef MESS
	static void jmp_1(void)	 	 { uint8_t i=M_RDOP(R.PC.w.l); R.PC.w.l = i | 0x100 | R.A11; change_pc16(R.PC.w.l); }
	static void jmp_2(void)	 	 { uint8_t i=M_RDOP(R.PC.w.l); R.PC.w.l = i | 0x200 | R.A11; change_pc16(R.PC.w.l); }
	static void jmp_3(void)	 	 { uint8_t i=M_RDOP(R.PC.w.l); R.PC.w.l = i | 0x300 | R.A11; change_pc16(R.PC.w.l); }
	static void jmp_4(void)	 	 { uint8_t i=M_RDOP(R.PC.w.l); R.PC.w.l = i | 0x400 | R.A11; change_pc16(R.PC.w.l); }
	static void jmp_5(void)	 	 { uint8_t i=M_RDOP(R.PC.w.l); R.PC.w.l = i | 0x500 | R.A11; change_pc16(R.PC.w.l); }
	static void jmp_6(void)	 	 { uint8_t i=M_RDOP(R.PC.w.l); R.PC.w.l = i | 0x600 | R.A11; change_pc16(R.PC.w.l); }
	static void jmp_7(void)	 	 { uint8_t i=M_RDOP(R.PC.w.l); R.PC.w.l = i | 0x700 | R.A11; change_pc16(R.PC.w.l); }
	static void jmpp_xa(void)	 { uint16_t addr = (R.PC.w.l & 0xf00) | R.A; R.PC.w.l = (R.PC.w.l & 0xf00) | M_RDMEM(addr); change_pc16(R.PC.w.l); }
	static void jb_0(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x01) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jb_1(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x02) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jb_2(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x04) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jb_3(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x08) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jb_4(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x10) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jb_5(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x20) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jb_6(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x40) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jb_7(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x80) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jf0(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (M_F0y) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jf1(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.f1)	{ R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jnc(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (M_Cn)	{ R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jc(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (M_Cy)	{ R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jni(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.irq_state == I8039_EXTERNAL_INT) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jnt_0(void)  	 { uint8_t i=M_RDMEM_OPCODE(); if (!test_r(0)) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jt_0(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (test_r(0))  { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jnt_1(void)  	 { uint8_t i=M_RDMEM_OPCODE(); if (!test_r(1)) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jt_1(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (test_r(1))  { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jnz(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A != 0)	 { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jz(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A == 0)	 { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); } else ADJUST_CYCLES }
	static void jtf(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.t_flag)	 { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; change_pc16(R.PC.w.l); R.t_flag = 0; } else ADJUST_CYCLES }
#else
	static void jmp_1(void)	 	 { uint8_t i=M_RDOP(R.PC.w.l); R.PC.w.l = i | 0x100 | R.A11; }
	static void jmp_2(void)	 	 { uint8_t i=M_RDOP(R.PC.w.l); R.PC.w.l = i | 0x200 | R.A11; }
	static void jmp_3(void)	 	 { uint8_t i=M_RDOP(R.PC.w.l); R.PC.w.l = i | 0x300 | R.A11; }
	static void jmp_4(void)	 	 { uint8_t i=M_RDOP(R.PC.w.l); R.PC.w.l = i | 0x400 | R.A11; }
	static void jmp_5(void)	 	 { uint8_t i=M_RDOP(R.PC.w.l); R.PC.w.l = i | 0x500 | R.A11; }
	static void jmp_6(void)	 	 { uint8_t i=M_RDOP(R.PC.w.l); R.PC.w.l = i | 0x600 | R.A11; }
	static void jmp_7(void)	 	 { uint8_t i=M_RDOP(R.PC.w.l); R.PC.w.l = i | 0x700 | R.A11; }
	static void jmpp_xa(void)	 { uint16_t addr = (R.PC.w.l & 0xf00) | R.A; R.PC.w.l = (R.PC.w.l & 0xf00) | M_RDMEM(addr); }
	static void jb_0(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x01) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jb_1(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x02) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jb_2(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x04) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jb_3(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x08) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jb_4(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x10) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jb_5(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x20) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jb_6(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x40) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jb_7(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A & 0x80) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jf0(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (M_F0y) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jf1(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.f1)	{ R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jnc(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (M_Cn)	{ R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jc(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (M_Cy)	{ R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jni(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.irq_state == I8039_EXTERNAL_INT) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jnt_0(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (!test_r(0)) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jt_0(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (test_r(0))  { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jnt_1(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (!test_r(1)) { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jt_1(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (test_r(1))  { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jnz(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A != 0)	 { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jz(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.A == 0)	 { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; } else ADJUST_CYCLES }
	static void jtf(void)	 	 { uint8_t i=M_RDMEM_OPCODE(); if (R.t_flag)	 { R.PC.w.l = ((R.PC.w.l-1) & 0xf00) | i; R.t_flag = 0; } else ADJUST_CYCLES }
#endif
...
static void rl_a(void)		 { uint8_t i=R.A & 0x80; R.A <<= 1; if (i) R.A |= 0x01; else R.A &= 0xfe; }
/* NS990113 */
static void rlc_a(void) 	 { uint8_t i=M_Cy; if (R.A & 0x80) SET(C_FLAG); else CLR(C_FLAG); R.A <<= 1; if (i) R.A |= 0x01; else R.A &= 0xfe; }
static void rr_a(void)		 { uint8_t i=R.A & 1; R.A >>= 1; if (i) R.A |= 0x80; else R.A &= 0x7f; }
/* NS990113 */
static void rrc_a(void)		 { uint8_t i=M_Cy; if (R.A & 1) SET(C_FLAG); else CLR(C_FLAG); R.A >>= 1; if (i) R.A |= 0x80; else R.A &= 0x7f; }
...
static void swap_a(void)	 { uint8_t i=R.A >> 4; R.A <<= 4; R.A |= i; }
static void xch_a_r0(void)	 { uint8_t i=R.A; R.A=R0; R0=i; }
static void xch_a_r1(void)	 { uint8_t i=R.A; R.A=R1; R1=i; }
static void xch_a_r2(void)	 { uint8_t i=R.A; R.A=R2; R2=i; }
static void xch_a_r3(void)	 { uint8_t i=R.A; R.A=R3; R3=i; }
static void xch_a_r4(void)	 { uint8_t i=R.A; R.A=R4; R4=i; }
static void xch_a_r5(void)	 { uint8_t i=R.A; R.A=R5; R5=i; }
static void xch_a_r6(void)	 { uint8_t i=R.A; R.A=R6; R6=i; }
static void xch_a_r7(void)	 { uint8_t i=R.A; R.A=R7; R7=i; }
static void xch_a_xr0(void)	 { uint8_t i=R.A; R.A=intRAM[R0 & 0x7f]; intRAM[R0 & 0x7f]=i; }
static void xch_a_xr1(void)	 { uint8_t i=R.A; R.A=intRAM[R1 & 0x7f]; intRAM[R1 & 0x7f]=i; }
...
#if (HAS_I8035)
/* Layout of the registers in the debugger */
static uint8_t i8035_reg_layout[] = {
...
/* Layout of the debugger windows x,y,w,h */
static uint8_t i8035_win_layout[] = {
	 0, 0,80, 2,	/* register window (top rows) */
	 0, 3,24,19,	/* disassembler window (left colums) */
	25, 3,55, 9,	/* memory #1 window (right, upper middle) */
	25,13,55, 9,	/* memory #2 window (right, lower middle) */
...
#if (HAS_I8048)
/* Layout of the registers in the debugger */
static uint8_t i8048_reg_layout[] = {
...
/* Layout of the debugger windows x,y,w,h */
static uint8_t i8048_win_layout[] = {
	 0, 0,80, 2,	/* register window (top rows) */
	 0, 3,24,19,	/* disassembler window (left colums) */
	25, 3,55, 9,	/* memory #1 window (right, upper middle) */
	25,13,55, 9,	/* memory #2 window (right, lower middle) */
...
#if (HAS_N7751)
/* Layout of the registers in the debugger */
static uint8_t n7751_reg_layout[] = {
...
/* Layout of the debugger windows x,y,w,h */
static uint8_t n7751_win_layout[] = {
	 0, 0,80, 2,	/* register window (top rows) */
	 0, 3,24,19,	/* disassembler window (left colums) */
	25, 3,55, 9,	/* memory #1 window (right, upper middle) */
	25,13,55, 9,	/* memory #2 window (right, lower middle) */
