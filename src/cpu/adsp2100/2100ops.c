...
static INLINE uint32_t pc_stack_top(void)
{
	if (adsp2100.pc_sp > 0)
...
static INLINE void set_pc_stack_top(uint32_t top)
{
	if (adsp2100.pc_sp > 0)
...
static INLINE void pc_stack_push_val(uint32_t val)
{
	if (adsp2100.pc_sp < PC_STACK_DEPTH)
	{
...
static INLINE uint32_t pc_stack_pop_val(void)
{
	if (adsp2100.pc_sp > 0)
	{
		adsp2100.pc_sp--;
...
static INLINE uint32_t cntr_stack_top(void)
{
...
static INLINE uint32_t loop_stack_top(void)
{
...
static INLINE void loop_stack_push(uint32_t value)
{
...
static void wr_inval(int32_t val)
{
...
static INLINE void modify_address(uint32_t ireg, uint32_t mreg)
{
...
static INLINE void data_write_dag1(uint32_t op, int32_t val)
{
...
static INLINE uint32_t data_read_dag1(uint32_t op)
{
	uint32_t ireg = (op >> 2) & 3;
	uint32_t mreg = op & 3;
	uint32_t base = adsp2100.base[ireg];
...
static INLINE void data_write_dag2(uint32_t op, int32_t val)
{
...
static INLINE uint32_t data_read_dag2(uint32_t op)
{
	uint32_t ireg = 4 + ((op >> 2) & 3);
	uint32_t mreg = 4 + (op & 3);
	uint32_t base = adsp2100.base[ireg];
...
static INLINE void pgm_write_dag2(uint32_t op, int32_t val)
{
	uint32_t ireg = 4 + ((op >> 2) & 3);
	uint32_t mreg = 4 + (op & 3);
	uint32_t base = adsp2100.base[ireg];
...
static INLINE uint32_t pgm_read_dag2(uint32_t op)
{
	uint32_t ireg = 4 + ((op >> 2) & 3);
	uint32_t mreg = 4 + (op & 3);
	uint32_t base = adsp2100.base[ireg];
