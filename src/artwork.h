...
/* Returns nonzero when the artwork/UI compositor is in the display path
   (artwork loaded or a UI overlay bitmap allocated). When zero, the game
   bitmap is delivered straight to the frontend. */
