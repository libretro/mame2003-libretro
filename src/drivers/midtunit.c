...
GAMEC( 1993, nbajam,   0,       tunit_adpcm, nbajam,    nbajam,   ROT0, "Midway",   "NBA Jam (rev 3.01 04/07/93)", &nbajam_ctrl, &nbajam_bootstrap )
GAMEC( 1993, nbajamr2, nbajam,  tunit_adpcm, nbajam,    nbajam20, ROT0, "Midway",   "NBA Jam (rev 2.00 02/10/93)", &nbajam_ctrl, &nbajamr2_bootstrap )
