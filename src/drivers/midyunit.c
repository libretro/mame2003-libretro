...
GAMECX( 1991, shimpact, 0,       hiimpact, trog,    shimpact, ROT0, "Midway",   "Super High Impact (rev LA1 09/30/91)", GAME_NOT_WORKING, &shimpact_ctrl, &shimpact_bootstrap )
GAMECX( 1991, shimpacp, shimpact,hiimpact, trog,    shimpacp, ROT0, "Midway",   "Super High Impact (prototype, rev 5.0 09/15/91)", GAME_NOT_WORKING, &shimpact_ctrl, &shimpacp_bootstrap )
