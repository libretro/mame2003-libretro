...
static uint16_t *ram;
static uint16_t *ram2;

extern uint16_t *nemesis_videoram1b;
extern uint16_t *nemesis_videoram1f;
extern uint16_t *nemesis_videoram2b;
extern uint16_t *nemesis_videoram2f;
extern uint16_t *nemesis_characterram;
extern uint16_t *nemesis_xscroll1,*nemesis_xscroll2, *nemesis_yscroll;
...
extern uint16_t *nemesis_yscroll1, *nemesis_yscroll2;
