...
extern uint16_t *cps2_objram1,*cps2_objram2;
extern uint16_t *cps2_output;
...
static uint8_t CPS2_Read8(uint32_t address)
{
	return m68k_read_pcrelative_8(address);
}

static uint16_t CPS2_Read16(uint32_t address)
{
	return m68k_read_pcrelative_16(address);
}

static uint32_t CPS2_Read32(uint32_t address)
{
...
GAMEC( 1996, ddsom,    0,       cps2, ddtod,   cps2, ROT0,   "Capcom", "Dungeons & Dragons: Shadow over Mystara (Euro 960619)", &ddsom_ctrl , &ddsom_bootstrap )
GAMEC( 1996, ddsomr1,  ddsom,   cps2, ddtod,   cps2, ROT0,   "Capcom", "Dungeons & Dragons: Shadow over Mystara (Euro 960209)", &ddsom_ctrl , &ddsom_bootstrap )
GAMEC( 1996, ddsomu,   ddsom,   cps2, ddtod,   cps2, ROT0,   "Capcom", "Dungeons & Dragons: Shadow over Mystara (US 960619)", &ddsom_ctrl , &ddsomu_bootstrap )
GAMEC( 1996, ddsomur1, ddsom,   cps2, ddtod,   cps2, ROT0,   "Capcom", "Dungeons & Dragons: Shadow over Mystara (US 960209)", &ddsom_ctrl , &ddsomu_bootstrap )
GAMEC( 1996, ddsomj,   ddsom,   cps2, ddtod,   cps2, ROT0,   "Capcom", "Dungeons & Dragons: Shadow over Mystara (Japan 960619)", &ddsom_ctrl , &ddsomj_bootstrap )
...
GAMEC( 1996, ddsoma,   ddsom,   cps2, ddtod,   cps2, ROT0,   "Capcom", "Dungeons & Dragons: Shadow over Mystara (Asia 960619)", &ddsom_ctrl , &ddsoma_bootstrap )
