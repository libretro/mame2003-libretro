...
uint16_t* mcatadv_videoram1, *mcatadv_videoram2;
uint16_t* mcatadv_scroll, *mcatadv_scroll2;
uint16_t* mcatadv_vidregs;
...
{
	uint8_t *z80rom = memory_region(REGION_CPU2) + 0x10000;
